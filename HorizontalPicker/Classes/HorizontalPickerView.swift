...
open class HorizontalPickerView: UIView {
    ...
    open override func layoutSubviews() {
        ...
        if let dataSource = dataSource, let delegate = delegate, dataSource.numberOfRowsInHorizontalPickerView(self) > 0  {
...
//                if let firstElement = delegate.horizontalPickerView(self, titleForRow: 0), let lastElement = delegate.horizontalPickerView(self, titleForRow: layout.lastElementIndex) {
                let firstElement = delegate.horizontalPickerView(self, titleForRow: 0)
                let lastElement = delegate.horizontalPickerView(self, titleForRow: layout.lastElementIndex)
